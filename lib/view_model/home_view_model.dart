...
enum HomeScreenState { intializing, loading, loaded, failed, notConnected }
...
shirts=await products!.where(((element) => element.category=='shirt'
)).toList();
...
skirt=await products!.where(((element) => element.category=='Skirts'
)).toList();
...
pants=await products!.where(((element) => element.category=='Pants'
)).toList();
...
skarfs=await products!.where(((element) => element.category=='Scarfs'
)).toList();
...
shorts=await products!.where(((element) => element.category=='Shorts'
)).toList();
